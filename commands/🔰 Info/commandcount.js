  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls, GuildSettings) => {
    ...
    try {
      ...
      let tempmsg = await message.reply({embeds: [new MessageEmbed()
        ...
        .setAuthor(client.getAuthor(handlemsg(client.la[ls].cmds.info.commandcount.tempmsg), "https://cdn.discordapp.com/emojis/756773010123522058.gif", "https://discord.gg/ZzECHdj2Jf"))
      ]})
      let lines = 0
      let letters = 0
