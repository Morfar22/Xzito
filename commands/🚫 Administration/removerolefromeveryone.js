   ...
   run: async (client, message, args, cmduser, text, prefix, player, es, ls, GuildSettings) => {
     ...
     try {
      ...
      return message.reply({embeds : [new MessageEmbed()
       ...
       let cmdroles = GuildSettings?.cmdadminroles?.removerolefromeveryone || [];
       var cmdrole = []
       if (cmdroles.length > 0) {
         for (const r of cmdroles) {
           if (message.guild.roles.cache.get(r)) {
              ...
              const File = `removerolefromeveryone`;
       ...
       message.reply({embeds:  [new MessageEmbed()
         ...
         .setFooter(client.getFooter(es))
         .setAuthor(`Changing roles for ${members.length} Members...`, "https://images-ext-1.discordapp.net/external/ANU162U1fDdmQhim_BcbQ3lf4dLaIQl7p0HcqzD5wJA/https/cdn.discordapp.com/emojis/756773010123522058.gif", "https://discord.gg/ZzECHdj2Jf")
