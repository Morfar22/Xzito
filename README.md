...
<details>
 ...
 ### Recommendations
  * a VPS would be adviced, so you don't need to keep your pc/laptop/raspi 24/7 online! [click here for a debian setup Guide](https://github.com/Morfar#0001/Debian-Cheat-Sheet-Setup/wiki/)
...
<details>
  ...
  **NOTE:** It is suggested to use the [Sharded (&Clustered) version](https://github.com/Morfar#0001/Multipurpose-discord-bot/tree/sharded_with_mongo), if u plan on using it for a VERIFIED BOT (on more then 2000 Servers!)
 
  1. Download the [Source Code](https://github.com/Morfar#0001/Multipurpose-discord-bot/releases/latest)
     * either by: `git clone https://github.com/Morfar#0001/Multipurpose-discord-bot`
...
<details>
  ...
  *There are many public ones out there for example lavalink.eu*
  ...
  1. Make sure `Java 11` is installed on your System!
     * [Click here for a Download for **Linux**](https://github.com/Morfar#0001/Debian-Cheat-Sheet-Setup/wiki/3.5.2-java-11)
...
<details>
  ...
  **NOTE:** *you can do the exact same configuration inside of the `example.env` File, just make sure to rename it to `.env` or use environment variables!*
   ...
   5. Now start the bot by typing opening a cmd in that folder and type: `node index.js` or `npm start`
     * If you don't want to keep the terminal open or if you're on linux, check out [pm2 (and my tutorial)](https://github.com/Morfar#0001/Debian-Cheat-Sheet-Setup/wiki/4-pm2-tutorial) and type: `pm2 start --name Bot_Name index.js`
...
<details>
  ...
  **NOTE:** *you can do the exact same configuration inside of the `example.env` File, just make sure to rename it to `.env` or use environment variables!*
  ...
  4. `./databaseUri.json`
     * `mongoUri` is your Mongouri, everything should be explained if you need a [**selfhosting Guide CLICK HERE**](https://github.com/Morfar#0001/Debian-Cheat-Sheet-Setup/wiki/5-Mongodb-Database) or a free [**MONGODB-ATLAS URL CLICK HERE**](https://www.mongodb.com/atlas/database)
